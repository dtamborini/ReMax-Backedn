...
builder.Services.AddHttpClient<IAssetDataProviderClient, AssetDataProviderClient>(client => {
    client.BaseAddress = new Uri(builder.Configuration["AssetDataProviderService:BaseUrl"]!);
});
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(options =>
    {
        ...
        options.OAuthAppName("AssetService Swagger UI");
